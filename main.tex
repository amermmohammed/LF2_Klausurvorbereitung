...
%%% end lines to page %%%
    ...
    \paragraph{\color{codegreen} Andre Beschreibung:\\\color{red}Ein Spürbarer Wiederstand\\\color{codegeen} Der taktile Switch reagiert am Schaltpunkt mit einem leichten, sehr präzisen und sofortigen Feedback. Ideal für Gaming Turniere und FPS-Gaming}
    ...
    \paragraph{\color{codegreen} Andre Beschreibung\\\color{red} Reibungsloser, fließender Tastenanschlag\\\color{codegeen} Die fließenden Funktionsweise linearer Switches eignet sich besonders für doppelte und schnelle mehrfache Anschläge. Sie sind ideal für Action-Spiele}
    \begin{center}
        \begin{figure}[H]
            \centering
